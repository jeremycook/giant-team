...
GRANT USAGE ON SCHEMA ws TO PUBLIC;
GRANT ALL ON SCHEMA ws TO pg_database_owner;

-- VIEW: ws.workspace
-- DROP VIEW ws.workspace;
CREATE OR REPLACE VIEW ws.workspace
 AS
 WITH columns AS (
 ...
 SELECT databases.name,
    databases.owner,
    databases.schemas AS zones
   FROM databases;

ALTER TABLE ws.workspace
    OWNER TO pg_database_owner;

GRANT ALL ON TABLE ws.workspace TO pg_database_owner;
GRANT SELECT ON TABLE ws.workspace TO PUBLIC;
