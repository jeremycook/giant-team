...
import { WorkspacePageData } from './pages/workspace/workspace';
    ...
    <Routes>
      ...
      <Route path='' component={Protected}>
        ...
        <Route path="/workspace/:workspace" component={lazy(() => import('./pages/workspace/workspace'))} data={WorkspacePageData}>
          ...
          <Route path='/table-designer' component={lazy(() => import('./pages/workspace/table-designer'))} />
          <Route path='/table-maker' component={lazy(() => import('./pages/workspace/table-maker'))} />
        </Route>
